              ...
              <AccordionItem value="faqs">
                ...
                <AccordionContent>
                  <div className="space-y-4 text-sm">
                    <div>
                      <h4 className="font-medium mb-2">How should I store this product?</h4>
                    ...
                    <div>
                      ...
                      <p className="text-neutral-600 dark:text-neutral-400">
                        This product has a shelf life of 24 months when stored properly.
                      </p>
                    </div>
                    <div>
                      <h4 className="font-medium mb-2">Is this product vegetarian?</h4>
                      <p className="text-neutral-600 dark:text-neutral-400">
                        {product.vegetarian ? "Yes, this product is 100% vegetarian." : "No, this product contains non-vegetarian ingredients."}
                      </p>
                    </div>
                  </div>
                </AccordionContent>
